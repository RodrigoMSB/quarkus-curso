...
|---------|-------------|------------|-------------|
| **Throughput** | 2586 req/s | 1745 req/s | Reactivo más rápido |
| **Latencia promedio** | 0.0191 | 0.0230 | Ambos en rango aceptable |
| **p50 (mediana)** | 0.0088 | 0.0057 | Experiencia típica |
| **p95** | 0.0637 | 0.1201 | Reactivo más consistente |
| **p99** | 0.0768 | 0.1850 | Peor 1% de usuarios |
...
| Métrica | Reactivo ⚡ | Clásico 📦 | Observación |
|---------|-------------|------------|-------------|
| **Throughput** | 8274 req/s | 1628 req/s | **DIFERENCIA BRUTAL** 🔥 |
| **Latencia promedio** | 0.0119 | 0.0590 | Reactivo significativamente mejor |
| **p50 (mediana)** | 0.0115 | 0.0415 | Experiencia del usuario promedio |
| **p95** | 0.0155 | 0.1797 | **Reactivo mucho mejor** 🚀 |
| **p99** | 0.0235 | 0.2577 | Clásico con latencias altas |
...
| Métrica | Reactivo ⚡ | Clásico 📦 | Observación |
|---------|-------------|------------|-------------|
| **Throughput** | 7720 req/s | 1627 req/s | Reactivo mantiene alto rendimiento |
| **Latencia promedio** | 0.0256 | 0.1193 | Diferencia significativa |
| **p50 (mediana)** | 0.0244 | 0.0955 | Usuario promedio sufre en clásico |
| **p95** | 0.0336 | 0.3360 | Reactivo mantiene consistencia |
| **p99** | 0.0536 | 0.4296 | Clásico con timeouts probables |
...
Datos reales:
├─ 1K:  Reactivo 2586 vs Clásico 1745 req/s
├─ 5K:  Reactivo 8274 vs Clásico 1628 req/s
└─ 10K: Reactivo 7720 vs Clásico 1627 req/s
```
...
50ms  ┤  ████ ████ ████ Reactivo (todas las cargas)
      │  R: 63.7000ms, 15.5000ms, 33.6000ms
0ms   └──┬────┬────┬─────────────
        1K   5K  10K
...
- Reactivo: 8274 req/s → Soporta 8274 usuarios/segundo
- Clásico: 1628 req/s → Soporta 1628 usuarios/segundo

Diferencia: 6646 usuarios más por segundo
```
...
```
Reactivo: 11.9000ms  ✅ Excelente
Clásico: 59.0000ms   ⚠️  Perceptible
```
...
```
Reactivo - p95 = 0.0155 significa:
├─ 4,750 usuarios (95%) tuvieron respuesta en ≤15.5000ms  ✅
└─ 250 usuarios (5%) tuvieron respuesta en >15.5000ms

Clásico - p95 = 0.1797 significa:
├─ 4,750 usuarios (95%) tuvieron respuesta en ≤179.7000ms ⚠️
└─ 250 usuarios (5%) tuvieron respuesta en >179.7000ms  ❌
```
...
- Latencias se disparan (p95 = 0.1797)
...
- Latencias consistentes (p95 = 0.0155)
...
|---------|----------|---------|-------|
| **Throughput 5K** | 8274 req/s | 1628 req/s | Reactivo |
| **Latencia p95 5K** | 0.0155 | 0.1797 | Reactivo |
...
**Fecha:** 2025-11-15 16:09:45  
**Archivos analizados:**
- Reactivo: `resultados-reactivo-20251115_160849.txt`
- Clásico: `resultados-clasico-20251115_160808.txt`
