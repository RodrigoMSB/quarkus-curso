...
public class TasaService {
    ...
    public Map<String, Object> obtenerConfiguracion() {
        ...
        // ORIGEN DEL API KEY (para verificación en tests)
        // En PROD, el API key viene desde Vault (seguro)
        // En DEV/TEST, viene desde application.properties (hardcoded)
        String apiKeySource = "prod".equals(activeProfile) ? "Vault" : "application.properties";
        configMap.put("api_key_source", apiKeySource);
