...
|---------|-------------|------------|-------------|
| **Throughput** | 2457 req/s | 1847 req/s | Reactivo más rápido |
| **Latencia promedio** | 0.0200 | 0.0204 | Ambos en rango aceptable |
| **p50 (mediana)** | 0.0132 | 0.0040 | Experiencia típica |
| **p95** | 0.0686 | 0.1241 | Reactivo más consistente |
| **p99** | 0.0754 | 0.1631 | Peor 1% de usuarios |
...
| Métrica | Reactivo ⚡ | Clásico 📦 | Observación |
|---------|-------------|------------|-------------|
| **Throughput** | 6363 req/s | 1502 req/s | **DIFERENCIA BRUTAL** 🔥 |
| **Latencia promedio** | 0.0155 | 0.0648 | Reactivo significativamente mejor |
| **p50 (mediana)** | 0.0145 | 0.0390 | Experiencia del usuario promedio |
| **p95** | 0.0243 | 0.2636 | **Reactivo mucho mejor** 🚀 |
| **p99** | 0.0319 | 0.3729 | Clásico con latencias altas |
...
| Métrica | Reactivo ⚡ | Clásico 📦 | Observación |
|---------|-------------|------------|-------------|
| **Throughput** | 6383 req/s | 1433 req/s | Reactivo mantiene alto rendimiento |
| **Latencia promedio** | 0.0310 | 0.1328 | Diferencia significativa |
| **p50 (mediana)** | 0.0303 | 0.1013 | Usuario promedio sufre en clásico |
| **p95** | 0.0397 | 0.3873 | Reactivo mantiene consistencia |
| **p99** | 0.0533 | 0.5191 | Clásico con timeouts probables |
...
Datos reales:
├─ 1K:  Reactivo 2457 vs Clásico 1847 req/s
├─ 5K:  Reactivo 6363 vs Clásico 1502 req/s
└─ 10K: Reactivo 6383 vs Clásico 1433 req/s
```
...
50ms  ┤  ████ ████ ████ Reactivo (todas las cargas)
      │  R: 68.6000ms, 24.3000ms, 39.7000ms
0ms   └──┬────┬────┬─────────────
        1K   5K  10K
...
- Reactivo: 6363 req/s → Soporta 6363 usuarios/segundo
- Clásico: 1502 req/s → Soporta 1502 usuarios/segundo

Diferencia: 4861 usuarios más por segundo
```
...
```
Reactivo: 15.5000ms  ✅ Excelente
Clásico: 64.8000ms   ⚠️  Perceptible
```
...
```
Reactivo - p95 = 0.0243 significa:
├─ 4,750 usuarios (95%) tuvieron respuesta en ≤24.3000ms  ✅
└─ 250 usuarios (5%) tuvieron respuesta en >24.3000ms

Clásico - p95 = 0.2636 significa:
├─ 4,750 usuarios (95%) tuvieron respuesta en ≤263.6000ms ⚠️
└─ 250 usuarios (5%) tuvieron respuesta en >263.6000ms  ❌
```
...
- Latencias se disparan (p95 = 0.2636)
...
- Latencias consistentes (p95 = 0.0243)
...
|---------|----------|---------|-------|
| **Throughput 5K** | 6363 req/s | 1502 req/s | Reactivo |
| **Latencia p95 5K** | 0.0243 | 0.2636 | Reactivo |
...
**Fecha:** 2025-11-19 14:39:15  
**Archivos analizados:**
- Reactivo: `resultados-reactivo-20251119_141626.txt`
- Clásico: `resultados-clasico-20251119_143638.txt`
