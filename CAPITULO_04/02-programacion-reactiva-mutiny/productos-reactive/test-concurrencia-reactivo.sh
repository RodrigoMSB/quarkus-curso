...
# ============================================================================
# TEST DE CONCURRENCIA CON K6 - ENFOQUE REACTIVO
# ============================================================================
...
run_test() {
    ...
    # Formato k6: http_req_duration..: avg=23.45ms min=1.2ms med=20.1ms max=150ms p(90)=45ms p(95)=67ms p(99)=89ms
    # Formato k6: http_reqs..........: 1000   2374.553/s
    ...
    # Convertir ms a secs (dividir por 1000)
