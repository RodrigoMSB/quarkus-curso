...
- ✅ **Validación exhaustiva** de datos (DNI peruano, email, rangos, etc.)
...
### 3️⃣ Validación de DNI inválido
...
```json
{
  "error": "DNI peruano inválido. Debe contener exactamente 8 dígitos."
}
```
